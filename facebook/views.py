...
def play2(request):
    ...
    return render(request, 'play2.html', { 'name': phy, 'diary': diary, 'cnt': count, 'age': status })
...
def event(request):
    ...
    return render(request, 'event.html', { 'name': phy, 'cnt': count, 'age': status, 'lottery': lottery })
